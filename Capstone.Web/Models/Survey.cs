...
namespace Capstone.Web.Models
{
    public class Survey
    {
        ...
        /// <summary>
        /// the email address of the user taking the survey
        /// </summary>
        [EmailAddress]
        [Required]
        ...
        /// <summary>
        /// the physical activity level of the user taking the survey.
        ...
        public IList<SelectListItem> Parks = new List<SelectListItem>
        {
                ...
                new SelectListItem() { Text="Yelllowstone National Park", Value="YNP"},
        ...
        /// <summary>
        /// the state of residence of the user taking the survey
        /// </summary>
        /// 
